let x = "";
console.log(x); // imprime uma linha com um espaço em branco, pois a variável x tem uma string vazia.
x = "oi";
...
Math.random() // retorna 0.7456916270759015  (Exemplo, visto que o número é randômico)
Math.random() // retorna 0.15449802102729304 (Exemplo, visto que o número é randômico)
Math.random() // retorna 0.4214269561951203  (Exemplo, visto que o número é randômico)

// Obs.: Para exibir qualquer um destes exemplos, é necessário usar o console.log().

// Documentação do objeto Math => https://developer.mozilla.org/pt-BR/docs/Web/JavaScript/Reference/Global_Objects/Math#description